    ...
    const AdminDashboard = ({ onLogout, userLevel, username }) => {
      ...
      const loadReports = async () => {
        try {
          ...
          setFilteredReports(processedReports); // Initialize filtered reports
          setError('');
        } catch (err) {
      ...
      // Add this function to handle report filtering (add after loadReports function)
      ...
      // Add this useEffect to handle automatic filtering when department selection changes
      useEffect(() => {
        handleReportFilter();
